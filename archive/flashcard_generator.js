...
console.log('✅ Created flashcard files:');
console.log('📄 flashcards-questions.html (print first)');
console.log('📄 flashcards-answers.html (print on back of same paper)');
console.log(`🎯 Total cards: ${recallItems.length} (${pages.length} pages)`);
console.log('\n📋 Printing Instructions:');
console.log('1. Open flashcards-questions.html in browser');
console.log('2. Print (Ctrl+P) - make sure to use actual size, not fit to page');
console.log('3. Take the printed sheets and put them back in printer (flip appropriately)');
console.log('4. Open flashcards-answers.html and print on the back');
console.log('5. Cut along dashed lines with scissors');
