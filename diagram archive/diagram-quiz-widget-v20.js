...
export default function diagramQuizWidget(quizCards, targetDiv) {
  ...
  function render(card) {
    ...
    window.diagramQuizCheck = () => {
      console.log('Check button clicked')
      checkAnswers(card)
    }
    
    window.diagramQuizReset = () => {
      console.log('Reset button clicked')
      loadCard(currentCardIndex)
    }
    
    window.diagramQuizNext = () => {
      console.log('NEXT BUTTON CLICKED VIA ONCLICK! Current index:', currentCardIndex)
    ...
    window.diagramQuizClose = () => {
      console.log('Close button clicked')
      widget.stop()
    }

    // Attach event listeners (backup method)
