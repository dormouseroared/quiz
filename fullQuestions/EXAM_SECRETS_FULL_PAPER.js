const EXAM_SECRETS_FULL_PAPER = [
  ...
  },
  {
    ...
    examStrategy: 5,
    examStrategyNotes:
      "Don't spend time on this one unless everything else is complete.",
    examCalculation: 3,
    exam_NOT: false,
    tagged: true,
  },
  {
    ...
    examStrategy: 5,
    examStrategyNotes:
      "I can remember that the smaller capacitor of the two in series has the greater share of the voltage.",
    examCalculation: 3,
    exam_NOT: false,
    tagged: true,
  },
  ...
  },
  {
    ...
    examStrategy: 2,
    examStrategyNotes:
      "See EX309 for transformer equations. Check the turns on both sides and do not write them down wrong from the start. Check! Also POWER on the primary side is equal to power on the secondary side, if losses are small, which means V = IR can be used for the related power formulas.",
    examCalculation: 2,
    exam_NOT: false,
    tagged: true,
  },
  ...
  },
  {
    ...
    examStrategy: 5,
    examStrategyNotes:
      "Calculate occupied bandwidth, then check schedule for limits of band. That gives the gap from bandwidth used to top of band. Put that over the top of band to get ppm.",
    examCalculation: 2,
    exam_NOT: false,
  },
  {
    ...
    syllabus: "3c.3",
    examStrategy: 1,
    examStrategyNotes: "Drilled! See the diagram with labels for a refresher.",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
