const EXAM_SECRETS_FULL_PAPER = [
    ...
    },
    {
        ...
        question: "A two way splitter for a couple of stacked 2m antennas requires two lengths of solid polythen coax ƛ / 4 long. These should be cut to:",
        image: "",
        options: [
            "104cm",
            "52cm",
    ...
    },
    {
        ...
        correct: 1,
        explanation: "The ƛ / 4 ground plane is effectively half a dipole., the other half being the reflection in the ground plane. Feed impedance of a dipole in free space is 73Ω, so a ƛ / 4 ground plane is 73 / 2 = 37Ω.",
        lookup: "See page(s) x of the Full Licence text book",
        syllabus: "4"
    },
    {
    ...
    },
    {
        ...
        question: "An amateur inadvertently uses a short lead ƛ / 4 long intended for use on an oscilloscope, where the characteristic impedance used is 75Ω. The lead is connected to a 50Ω dummy load. The impedance at the free end will be:",
        image: "",
        options: [
            "37Ω",
            "50Ω",
    ...
    },
    {
        ...
        question: "When sending an Olivia data signal with a bandwidth of about 350kHz in the 472kHz band, it is recommended to use frequencies between:",
        image: "",
        options: [
            "472.0-479.0kHz",
            "472.0-475.0kHz",
        ...
        correct: 2,
        explanation: "The 472kHz (600m) Band Plan recommends 475-479kHz for CW and digital modes over 200kHz bandwidth. The 472-475kHz part is for modes with a bandwidth of less than 200kHz.",
        lookup: "See page(s) x of the Full Licence text book",
        syllabus: "7"
    },
    {
        source: "Exam Secrets FULL PAPER Q50",
        question: "What is the risk, in an amateur radio context, if a PME mains supply suffers a break in the neutral conductor somewhere in the street outside the premises?",
        image: "",
        options: [
        ...
        correct: 2,
        explanation: "If the supply Neutral is ruptured in the street, then the house Neutral will rise to near Live potential through connected appliances. If the premises have a PME supply, then the house Earth will be connected to the incoming Neutral at the Main Earth Terminal (MET) beside the company fuse and meter. That means the house Earth will also rise to near Live voltage, as will all exposed metalwork which is bonded to the house Earth. Not all exposed metalwork need be bonded to the MTE, which is explained in Chapter 3 under PME. [8a.2]",
        lookup: "See page(s) x of the Full Licence text book",
        syllabus: "8a.2"
    },
    {
        source: "Exam Secrets FULL PAPER Q51",
        question: "A fellow amateur terminates the feeders on a copper panel, where they enter the shack, to allow manual antenna selection. There is a Radio Frequency Choke (RFC) between each centre conductor and the earthed panel. What is the purpose of the RFC?",
        image: "",
        options: [
        ...
        correct: 0,
        explanation: "RFCs are fairly high inductance, often wound on a ferrite slug intended to pass modest currents, but block RF. They won't affect the RF characteristics of the installation, but will provide a DC static discharge path.",
        lookup: "See page(s) x of the Full Licence text book",
        syllabus: "8"
    },
    {
        source: "Exam Secrets FULL PAPER Q52",
        question: "You are proposing to run an amateur radio station at a scout camp, and have access to a shed for dry storage and mains power. As part of your planning, you must check the:",
        image: "",
        options: [
        ...
        correct: 1,
        explanation: "All the options have their merits, but the one affecting SAFETY is the goodness and adequacy of the mains supply and the provision of RCBOs. That, the other options listed, and several other factors, including RF field strengths, should be the subject of a written Risk Assessment.",
        lookup: "See page(s) x of the Full Licence text book",
        syllabus: "8"
    },
    {
        source: "Exam Secrets FULL PAPER Q53",
        question: "One of the documents an insurance company is likely to want to see when requesting cover for club meetings and training courses at a new club premises is:",
        image: "",
        options: [
    ...
    },
    {
        ...
        correct: 1,
        explanation: "As a voltmeter, it will need a series resistor to limit the current to 50µA when 15V is applied of value R = V / I.",
        lookup: "See page(s) x of the Full Licence text book",
        syllabus: "9"
    },
    {
        source: "Exam Secrets FULL PAPER Q55",
        question: "An RF voltmeter is calibrated to read RMS voltages and indicates the key down CW output from a transmitter is 145V into the feeder. What power does this represent?",
        image: "",
        options: [
            "210W",
            "300W",
    ...
    },
    {
        ...
        question: "The oscilloscope shown in the drawing has the time base set to 500µS/div and the Y amplifier to 10V/div. What is the frequency of the signal?",
        ...
        correct: 2,
        explanation: "Inspection of the drawing shows 4 divisions per wavelength so that's 4 x 500µS. Knowing the cycle time or period, the frequency is the inverse.",
        lookup: "See page(s) x of the Full Licence text book",
        syllabus: "9"
    },
    {
        source: "Exam Secrets FULL PAPER Q57",
        question: "A microphone amplifier is designed for an audio input of 4mV and an output of 0.6V. The input and output impedances are both 600Ω. The gain of the amplifier is:",
        image: "",
        options: [
            "11.8dB",
            "21.8dB",
    ...
    },
    {
        ...
        question: "A tuned circuit comprises a capacitor of 100pF and an inductor of 200µH. The inductor has a temperature coefficient of +3ppm per degree C. What temperature coefficient is needed for the capacitor to keep the centre frequency as stable as possible?",
        image: "",
        options: [
            "+3ppm",
            "-3ppm",
        ...
        correct: 1,
        explanation: "The need is to bring the overall coefficient as close to zero as possible. In this case, zero is achieved by choosing a capacitor with a -3ppm coefficient. The fact that the value of one is 100 units and the other 200 units is not relevant.",
        lookup: "See page(s) x of the Full Licence text book",
        syllabus: "9"
    },
]
