const EXAM_SECRETS_QUESTIONS = [
  ...
  },
  {
    ...
    syllabus: "1c.1",
    examStrategy: 2,
    examStrategyNotes: "Check EX309 option first.",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
    ...
    correct: 0,
    explanation:
      "More to find out about the The Wireless Telegraphy (Content of Transmission) Regulations 1988",
    lookup: "See page(s) x of the Full Licence text book",
    syllabus: "1c.1",
    examStrategy: 2,
    examStrategyNotes: "This is a fairly obvious one.",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
  ...
  },
  {
    ...
    examStrategy: 1,
    examStrategyNotes:
      "See EX309 7-1b, which allows inspection at any and all reasonable times, or of it is an URGENT situation, AT ANY TIME.",
    examCalculation: 0,
    exam_NOT: false,
    tagged: true,
  },
  ...
  },
  {
    ...
    syllabus: "1c.1",
    examStrategy: 3,
    examStrategyNotes: "Lots of drilling.",
    examCalculation: 0,
    exam_NOT: false,
    tagged: true,
  },
  ...
  },
  {
    ...
    syllabus: "7h.1",
    examStrategy: 1,
    examStrategyNotes: "Straight bat on this one.",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
  ...
  },
  {
    ...
    examStrategy: 4,
    examStrategyNotes:
      "Always go to EX309 Section 10 for definitions. They are in alphabetical order. There is no chance of remembering this, so do not try. GO AND LOOK IT UP!!!",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
    ...
    syllabus: "1h.1",
    examStrategy: 3,
    examStrategyNotes: "It is another 5MHz gotcha.",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
  ...
  },
  {
    ...
    syllabus: "2b.1",
    examStrategy: 3,
    examStrategyNotes: "Take it steady and all will be revealed.",
    examCalculation: 2,
    exam_NOT: false,
  },
  {
  ...
  },
  {
    ...
    correct: 1,
    explanation:
      "This question requires some thought. <br> Option C can be discounted, as the back EMF won't remain at one end with an alternating current. <br> Option D is also out, as inductive back EMF occurs when a current changes, no back EMF for steady currents. <br> Choice is now A or B. An inductor tries to oppose a current increase. In A it is aiding so A seems wrong. In B it is trying to keep the current going when the external drive is to reduce it. That is true, we have our answer. Note opposition to change is equally true for increasing or decreasing currents.",
    lookup: "See page(s) x of the Full Licence text book",
    syllabus: "2d.4",
    examStrategy: 4,
    examStrategyNotes:
  ...
  },
  {
    ...
    syllabus: "2d.4",
    examStrategy: 5,
    examStrategyNotes: "If you can drill this one, fine, otherwise move on!",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
  ...
  },
  {
    ...
    syllabus: "2e.5",
    examStrategy: 4,
    examStrategyNotes: "Just have to go for it. rfc is Radio Frequency Choke.",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
    ...
    correct: 2,
    explanation:
      "This question uses a variation of the formula from EX309 to get $Z^2 = R^2 + X^2$ Look out for 3-4-5 right angled triangle ratios to avoid  the calculator.",
    lookup: "See page(s) x of the Full Licence text book",
    syllabus: "2e.6",
    examStrategy: 1,
    examStrategyNotes:
      "Use EX309 for Z in terms of R and X. Remember Pythagoras.",
    examCalculation: 1,
    exam_NOT: false,
  },
  {
  ...
  },
  {
    ...
    tagged: false,
    examStrategy: 4,
    examStrategyNotes: "I find the way this is expressed to be very ambiguous.",
    examCalculation: 3,
    exam_NOT: false,
  },
  {
    ...
    correct: 1,
    explanation: `The ferrite is to improve the magnetic coupling and inductance. 
    The key need is to get the right grade of ferrite for the chosen IF. The coil
    and associated capacitor will resonate, but the ferrite doesn't. 
    Aluminium screens are used for IF transformers.`,
    lookup: "See page(s) x of the Full Licence text book",
    syllabus: "2g.1",
    examStrategy: 1,
    examStrategyNotes:
      "Drill... remembering that the ferrite does not resonate.",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
  ...
  },
  {
    ...
    correct: 3,
    explanation:
      "The resonant frequency formula is on EX309 C3R6. Take care with units! Try an estimate first.",
    lookup: "See page(s) x of the Full Licence text book",
    syllabus: "2h.1",
    examStrategy: 4,
    examStrategyNotes:
      "It is resonant frequency then convert to wavelength and choose nearest band.",
    examCalculation: 3,
    exam_NOT: false,
  },
  {
  ...
  },
  {
    ...
    correct: 1,
    explanation:
      "There are two key requirements. The gain in the amplifier must not be less than the loss in the feedback, or any oscillation will die out. The phase of the amplifier and feedback must be such that there is no overall phase change round the loop. Either both devices have a zero degree change, or both have 180 degree change at the wanted frequency. Note answer A may be a true statementm but it isn't the answer to the question asked.",
    lookup: "See page(s) x of the Full Licence text book",
    syllabus: "2i.5",
    examStrategy: 4,
    examStrategyNotes: "We don't want the oscillations to die out.",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
    ...
    examStrategy: 5,
    examStrategyNotes:
      "No idea about this one. Need some learning materials: Claude?",
    examCalculation: 1,
    exam_NOT: false,
  },
  {
  ...
  },
  {
    ...
    syllabus: "3c.3",
    examStrategy: 3,
    examStrategyNotes: "In simple terms 6/480 = f/34880",
    examCalculation: 2,
    exam_NOT: false,
  },
  {
    ...
    image: "images/secrets 3C3-2a.png",
    options: [
    ...
    syllabus: "3c.3",
    examStrategy: 1,
    examStrategyNotes: "Drill. See diagram quiz for this one.",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
    ...
    examStrategy: 3,
    examStrategyNotes:
      "It's FM so suitable for a multiplier. Try each answer times 3 (converting from about 3 to about 10...) and see if anything happens. The 9cm is just fluff, so no point in converting it to a frequency. It actually comes out at 3.3GHz, so it's some background information.",
    examCalculation: 2,
    exam_NOT: false,
  },
  {
    ...
    examStrategy: 3,
    examStrategyNotes:
      "This formula is on EX309 starting 'BW =', about half way down in the centre column.",
    examCalculation: 2,
    exam_NOT: false,
  },
  {
    ...
    syllabus: "3e.1",
    examStrategy: 5,
    examStrategyNotes: "Stinker. Move on. If there's time go through it...",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
    ...
    correct: 2,
    explanation:
      "Non-linear amplifiers can only be used where the RF level does not change, other than simple on or off, as in CW. Some data systems appear to be of constant amplitude, but do have momentary amplitude variations during the change from one data symbol to the next.They too need linear amplifiers to avoid spurious RF at other frequencies during the change.",
    lookup: "See page(s) x of the Full Licence text book",
    syllabus: "3f.2",
    examStrategy: 4,
    examStrategyNotes: "Choos one, and choose wisely.",
    examCalculation: 0,
    exam_NOT: false,
    tagged: true,
  },
  {
    ...
    syllabus: "3f.2",
    examStrategy: 3,
    examStrategyNotes: "Choose wisely.",
    examCalculation: 0,
    exam_NOT: false,
    tagged: true,
  },
  ...
  },
  {
    ...
    examStrategy: 3,
    examStrategyNotes:
      "CBE to start with, find the Collector, then common sense. For what it's worth, rfc is a radio frequency choke.",
    examCalculation: 0,
    exam_NOT: false,
    tagged: true,
  },
  ...
  },
  {
    ...
    syllabus: "3f.5",
    examStrategy: 1,
    examStrategyNotes: "Automatic Level Control.",
    examCalculation: 0,
    exam_NOT: false,
    tagged: true,
  },
  ...
  },
  {
    ...
    syllabus: "3g.2",
    examStrategy: 2,
    examStrategyNotes: "Increased bandwidth",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
  ...
  },
  {
    ...
    correct: 2,
    explanation:
      "The 2.7kHz filter will be in the receiver IF. The strong broadcast signal on 7.22MHz will be inside the bandwidth of the RF front end amplifier and is evidently overloading it. That is causing multiple intermodulation products, seen as a generaL increase in the noise floor for several kHz around the broadcast and masking the wanted signal. <i>It might be that a small input attenuator will reduce the overload and multiple intermodulation products, without reducing the wanted signal so much that it is then unusable.</i>",
    lookup: "See page(s) x of the Full Licence text book",
    syllabus: "3h.3",
    examStrategy: 2,
    examStrategyNotes:
      "Pay attention to what happens when a receiver is overloaded,and it causes <mark>intermodulation products</mark>. ",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
  ...
  },
  {
    ...
    correct: 3,
    explanation:
      "Option B can be discounted, as the LO should not be on the IF. Option C is the wanted signal tuning range, so won't be the LO range. Options A and D would both give the required tuning range and IF, however the question asks for the best choice, acknowledging there is more than one possibility. Tuning from 1065kHz to 2065kHz is a 2:1 tuning range; tuning from 135kHz to 1135kHz is an 8.4:1 range, which is inherently harder. It would also required a 70:1 capacitor range in a tuned circuit. This is not normally achievable in one span. Note that the answer has at least 1 error, which I corrected.",
    lookup: "See page(s) x of the Full Licence text book",
    syllabus: "3i.3",
    examStrategy: 4,
  ...
  },
  {
    ...
    options: [
      ...
      "the image frequency attenuation is a lot poorer than the out of band attenuation of the new IF filter",
  ...
  },
  {
    ...
    syllabus: "3n.1",
    examStrategy: 3,
    examStrategyNotes: "automatic level control is ALC",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
  ...
  },
  {
    ...
    examStrategy: 2,
    examStrategyNotes:
      "Do not get smug about these Return Loss questions but it is going well so far!",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
    ...
    examStrategy: 4,
    examStrategyNotes:
      "A balun works with unbalanced feeders to reduce their common mode currents. No mention of feeder.",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
  ...
  },
  {
    ...
    examStrategy: 4,
    examStrategyNotes:
      "Write out: Power Flux Density (PFD) is inversely proportional to the square of distance and (Electric) Field Strength (EFS) is inversely proportional to distance.",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
    ...
    syllabus: "5a.3",
    examStrategy: 4,
    examStrategyNotes: "Keep a lookout for this one! In the meantime, drill!",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
  ...
  },
  {
    ...
    examStrategy: 3,
    examStrategyNotes:
      "Surprisingly not covered in our tutorials, but try to remember it is winter and day.",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
    ...
    tagged: true,
    examStrategy: 3,
    examStrategyNotes: "LUF is lowest, MUF is highest. ",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
  ...
  },
  {
    ...
    examStrategy: 3,
    examStrategyNotes:
      "What happens to HF signals when they get refracted in the ionosphere? For more see a lot of flashcards attached to this syllabus item.",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
    ...
    examStrategy: 4,
    examStrategyNotes:
      "Think about this one. The closer the moon is, the better, and the position of the sun is neither here nor there",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
    ...
    syllabus: "5c.3",
    examStrategy: 3,
    examStrategyNotes: "Watch out for the movement of those Auroral curtains.",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
    ...
    options: [
      ...
      "random electron movement in crystal lattices in semiconductors",
    ],
    correct: 2,
    explanation:
  ...
  },
  {
    ...
    syllabus: "6b.1",
    examStrategy: 3,
    examStrategyNotes: "That is just the way it is.",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
    ...
    syllabus: "6b.1",
    examStrategy: 3,
    examStrategyNotes: "Probably still relevant.",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
    ...
    syllabus: "6b.2",
    examStrategy: 3,
    examStrategyNotes: "Watch the clip and update these notes.",
    examCalculation: 0,
    exam_NOT: false,
  ...
  },
  {
    ...
    syllabus: "6b.3",
    examStrategy: 3,
    examStrategyNotes: "Think Rusty Bolt Effect!",
    examCalculation: 0,
    exam_NOT: false,
  ...
  },
  {
    ...
    syllabus: "6c.1",
    examStrategy: 3,
    examStrategyNotes: "Link to a clip when you find it.",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
  ...
  },
  {
    ...
    examStrategy: 3,
    examStrategyNotes:
      "Think SAFETY!! And don't just pick the first one. It's about picking the best one, always!!",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
  ...
  },
  {
    ...
    syllabus: "8a.6",
    examStrategy: 3,
    examStrategyNotes: "Another well drilled answer.",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
    ...
    tagged: true,
    examStrategy: 3,
    examStrategyNotes: "Any mention of electromagnetic?",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
    ...
    syllabus: "8e.1",
    examStrategy: 3,
    examStrategyNotes: "It is that build up of static charge again.",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
  ...
  },
  {
    ...
    examStrategy: 4,
    examStrategyNotes:
      "Evidently being able to operate hands free is seen as a priority.",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
  ...
  },
  {
    ...
    syllabus: "8f.6",
    examStrategy: 3,
    examStrategyNotes: "The one that looks like a risk assessment.",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
  ...
  },
  {
    ...
    examStrategy: 5,
    examStrategyNotes:
      "Just leave until last. Look at the Exam Secrets explanation and work through it.",
    examCalculation: 4,
    exam_NOT: false,
  },
  {
  ...
  },
  {
    ...
    examStrategy: 4,
    examStrategyNotes:
      "Pay really close attention to the conversion of RMS to peak to peak. It is a two stage process. I hope to stop kicking myself soon! Remember that those sneaky examiners will have all the wrong answers to choose from.",
    examCalculation: 2,
    exam_NOT: false,
  },
  {
  ...
  },
  {
    ...
    correct: 2,
    explanation:
      "This is often misunderstood, but the answer is provided. See Note (e) to Schedule 1 of the licence which is provided in the exam.",
    lookup: "See page(s) x of the Full Licence text book",
    syllabus: "9a.5",
    examStrategy: 2,
    examStrategyNotes: "Look up EX309 Schedule 1. Definitions.",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
    ...
    syllabus: "9a.6",
    examStrategy: 3,
    examStrategyNotes: "I did this with just common sense...",
    examCalculation: 1,
    exam_NOT: false,
  },
  {
  ...
  },
  {
    ...
    syllabus: "9a.9",
    examStrategy: 2,
    examStrategyNotes: "Just look up the frequency on the scale...",
    examCalculation: 1,
    exam_NOT: false,
  },
  {
    ...
    syllabus: "9b.1",
    examStrategy: 5,
    examStrategyNotes: "Must revise the voltages and note where that is...",
    examCalculation: 1,
    exam_NOT: false,
  },
  {
