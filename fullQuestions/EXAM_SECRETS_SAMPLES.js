const EXAM_SECRETS_SAMPLES = [
    ...
    },
    {
        ...
        correct: 1,
        explanation: "HF signals often undergo polarisation change in the ionosphere, so the appropriate polarisation of a receive antenna is unpredictable",
        lookup: "See page(s) x of the Full Licence text book",
        syllabus: "5b.4"
    },
    {
        ...
        correct: 3,
        explanation: "The moon is a poor RF reflector and even with sharp focussing, most of the transmitted signal misses the moon. The distance to the moon can be the deciding factor in overall path loss and success of the contact.",
        lookup: "See page(s) x of the Full Licence text book",
        syllabus: "5c.3"
    },
    {
        ...
        correct: 2,
        explanation: "Auroral communication is by reflection  of the ionised curtains which form the polar regions. These move or flutter due to the random arrival of charged particles interacting with the Earth's magnetic field and gas particles in the upper atmosphere.",
        lookup: "See page(s) x of the Full Licence text book",
        syllabus: "5c.3"
    },
    {
        ...
        correct: 2,
        explanation: "Galactic noise is the name given to random background noise originating outside the Earth and its atmosphere",
        lookup: "See page(s) x of the Full Licence text book",
        syllabus: "5d.1"
    },
    {
        ...
        correct: 3,
        explanation: "A link budget is the sum of all the gains and losses between the transmitter output socket and the receiver input socket. That allows a calculated prediction of the signal strength at the receiver, given the transmit power , and thus the likely success of the contact.",
        lookup: "See page(s) x of the Full Licence text book",
        syllabus: "5d.2"
    },
    {
        ...
        correct: 1,
        explanation: "Both 'compromise its safe...' and 'considerable interference...' are credible answers, but the safety consideration is the better answer.",
        lookup: "See page(s) x of the Full Licence text book",
        syllabus: "6a.2"
    },
    {
        source: "Exam Secrets FULL [EMC] 6A4-1",
        question: "When you modify a commercial transceiver to operate in an amateur band you must ensure the device complies with the requirements of:",
        image: "",
        options: [
        ...
        correct: 0,
        explanation: "The requirement is simply to comlpy with the standards in your licence: particularly clause 7 on Equipment. You may like to check the other standards as a technical guide, but that is a personal choice.",
        lookup: "See page(s) x of the Full Licence text book",
        syllabus: "6a.4"
    },
    {
        source: "Exam Secrets FULL [EMC] 6B1-1",
        question: "It is noticed that leaving a mobile phone next to the bedside clock-radio results in occasional clicking and buzzing noises. This is:",
        image: "",
        options: [
        ...
        correct: 3,
        explanation: "Mobile phones need to keep periodic contact with a local base station so incoming calls can be correctly routed. If placed alongside other electrical equipment it is not realistic to expect no interaction. Only a modest separation is required to avoid problems.",
        lookup: "See page(s) x of the Full Licence text book",
        syllabus: "6b.1"
    },
    {
        source: "Exam Secrets FULL [EMC] 6B1-2",
        question: "A significant risk of importing electrical equipment is that it may:",
        image: "",
        options: [
        ...
        correct: 0,
        explanation: "All the answers could be a true statement, but non-compliance with EMC regulations could give rise to interference problems and might alsorisk electrical safety.",
        lookup: "See page(s) x of the Full Licence text book",
        syllabus: "6b.1"
    },
    {
        source: "Exam Secrets FULL [EMC] 6B2-1",
        question: "Which mode of transmission is most likely to be a cause of cross-modulation?",
        image: "",
        options: [
            "SSB",
            "FM",
    ...
    },
    {
        ...
        correct: 1,
        explanation: "This is a case of playing with the numbers. Can signals on 3.60 and 3.78MHz cause a signal on 3.96MHz? The affected frequency is above both transmissions, so the first option is (2 x 3.78) - 3.60 = 3.96! Found it! Corroded contacts can be partially rectifying, particularly if one of the signals is quite strong, and this can cause intermodulation products.",
        lookup: "See page(s) x of the Full Licence text book",
        syllabus: "6b.3"
    },
    {
    ...
    },
    {
        ...
        question: "Which transmission risks overloading a TV mast-head pre-amplifier?",
        image: "",
        options: [
            "2m FM",
            "40m SSB",
        ...
        correct: 0,
        explanation: "Many masthead amplifiers cover either from about 50MHz (old TV bands in many continental countries) or 90MHz (bottom of VHF sound broadcasts) up to around 900MHz, which was the top of most TV broadcast bands. 2m and 70cm are inside that range.",
        lookup: "See page(s) x of the Full Licence text book",
        syllabus: "6c.2"
    },
    {
        ...
        correct: 2,
        explanation: "The third harmonic of 3.567MHz is 10.7MHz, which is the standard intermediate frequency of domestic FM broadcast receivers. That is easily the most likely option.",
        lookup: "See page(s) x of the Full Licence text book",
        syllabus: "6c.3"
    },
    {
        ...
        correct: 2,
        explanation: "This is a 'remember it' question, either directly as in this question, or to answer an EMC question as in 6C3-1, where knowing the IF was an integral part of selecting the correct answer.",
        lookup: "See page(s) x of the Full Licence text book",
        syllabus: "6c.3"
    },
    {
        source: "Exam Secrets FULL [EMC] 6D1-1",
        question: "Several ferrite rings are fitted over a two-wire ribbon feeder. This is found to have no effect on the transmitted signal. Why?",
        image: "",
        options: [
            "The ferrite is not very effective at radio frequencies.",
            "The RF currents are in phase in each conductoe,and have no net effect.",
        ...
        correct: 3,
        explanation: "The wanted signal, transmit or receive, coax or twin wire, is always differential mode. That isd, the currents at any point are always in opposite directions with no overall magnetic field. If there is no field, the ferrite rings will have no effect.",
        lookup: "See page(s) x of the Full Licence text book",
        syllabus: "6d.1"
    },
    {
        source: "Exam Secrets FULL [EMC] 6D1-2",
        question: "Tests suggest that RF is being picked up on the loudspeaker leads of a music system and the speech is heard from the loudspeakers. The most likely effective cure is fitting:",
        image: "",
        options: [
    ...
    },
    {
        ...
        question: "The drawing shows a ccoaxial stub to remove a 2m amateur signal from a 100MHz VHF transmission. The stub should be open circuit at the free end and:",
        ...
        correct: 0,
        explanation: "The aim is to put a short circuit across the input at 145MHz to attenuate signals picked up at that frequency and do minimal damage to signals at 100MHz. An open circuit stub ƛ/4 at 145MHz will have that effect.",
        lookup: "See page(s) x of the Full Licence text book",
        syllabus: "6d.1"
    },
    {
        source: "Exam Secrets FULL [EMC] 6D1-4",
        question: "A 2m amateur antenna and a broadcast TV antenna are mounted on the same roof. To minimise the risk of problems, it is helpful to fit a:",
        image: "",
        options: [
        ...
        correct: 0,
        explanation: "The aim is to keep 145MHz out of the TV input at frequencies above 470MHz. There could be small harmonics of 145MHz at 290, 435 and 580MHz. 725MHz is now off the top of the TV band. However, the key need is to avoid a strong signal at 145MHz getting into the TV and causing overload or non-linearity. The best bet is a high-pass filter allowing frequencies above 470MHz in the TV aerial lead.",
        lookup: "See page(s) x of the Full Licence text book",
        syllabus: "6d.1"
    },
    {
    ...
    },
    {
        ...
        question: "If the RF earth on an HF transmitter is missing or not well installed, it is quite likely that:",
        image: "",
        options: [
    ...
    },
    {
        ...
        correct: 1,
        explanation: "Keeeping the antenna, feeder and transceiver power and control wiring as far away from the vehicle electrics will minimise the risk of RF pickup. Consider also the field strength in the passenger compartment.",
        lookup: "See page(s) x of the Full Licence text book",
        syllabus: "6f.2"
    },
    {
        source: "Exam Secrets FULL [EMC] 6F2-2",
        question: "To minmise the likelihood of RF being conducted into the vehicle electronics and in the absence of specific manufacturer instructions:",
        image: "",
        options: [
    ...
    },
    {
        ...
        correct: 2,
        explanation: "Telephone equipment requires approval for connection to the network and should not therefore be modified since it will invalidate the approval. The best option is a ferrite ring. In severe cases more than one ring might be required to get sufficient inductance.",
        lookup: "See page(s) x of the Full Licence text book",
        syllabus: "6g.1"
    },
    {
        source: "Exam Secrets FULL [OPERATING] 7A1-1",
        question: "You hear a station calling CQ and clearly getting frequent replies, but your replies are not getting any response. It is a strong station, and propagation is good. Why might that be?",
        image: "",
        options: [
    ...
    },
    {
        ...
        question: "You are holding an HF CW contact with another amateur but you are constantly interrupted by other contacts on SSB. The most likely reason is that:",
        image: "",
        options: [
    ...
    },
    {
        ...
        question: "In a premises supplied using PME practice, the supply company will have connected the prenises' main earth point to:",
        image: "",
        options: [
        ...
        correct: 1,
        explanation: "There is no separate earth conductor in a PME electricity supply. Instead, the neutral conductor is earthed at the sub-station, and at points along the road. In the house, the domestic safety earth is connected, cross-bonded, to the supply neutral.",
        lookup: "See page(s) x of the Full Licence text book",
        syllabus: "8a.2"
    },
    {
        ...
        correct: 1,
        explanation: "Normally, one should work on unplugged equipment, but there are occasions where adjustments need to made while working. Under those circumstances, one hand should be kept away so that even if a shock is experienced, it won't be across the chest and affect the heart rhythm.",
        lookup: "See page(s) x of the Full Licence text book",
        syllabus: "8a.6"
    },
    {
    ...
    },
    {
        ...
        correct: 0,
        explanation: "The spark gap is fitted between the antenna feeder and earth. It is designed to conduct at around 350V preoviding static protection and limited protection against nearby lightning strikes. The conduction potential is too high to protect semiconductor receiver front ends. That requires a medium high value resistor which won't protect from lightning induced surges.",
        lookup: "See page(s) x of the Full Licence text book",
        syllabus: "8e.1"
    },
    {
        source: "Exam Secrets FULL [SAFETY] 8F4-1",
        question: "When operating a special event station in tented accommodation, and using an extension cable to provide mains power, it is necessary to:",
        image: "",
        options: [
        ...
        correct: 0,
        explanation: "Any outside use of mains carries an increased risk. An RCBO both in the supply building and at the tent site are essential. Filtering might be helpful but is not as important as the RCBO. An overhead supply will keep it out of reach, but might exacerbate RF noise or pickup.",
        lookup: "See page(s) x of the Full Licence text book",
        syllabus: "8f.4"
    },
    {
