const CLAUDE_QUIZ = [
  {
    ...
    image: "",
    options: ["114 ohms", "228 ohms", "456 ohms", "912 ohms"],
    correct: 0,
  ...
  },
  {
    ...
    image: "",
    options: ["940μF", "470μF", "235μF", "117.5μF"],
    correct: 2,
    explanation:
  ...
  },
  {
    ...
    image: "",
    options: ["1 second", "10 seconds", "100 seconds", "0.1 seconds"],
    correct: 1,
    explanation:
      "Use EX309! Time constant τ = RC = 10×10³ × 1000×10⁻⁶ = 10 seconds",
    lookup: "See RC time constant formula",
    syllabus: "2d.7",
    examStrategy: 2,
    examStrategyNotes: "See EX309 for time constant in terms of C and R.",
    examCalculation: 1,
    exam_NOT: false,
  },
  {
    ...
    image: "",
    options: ["Electrolytic", "Tantalum", "Ceramic", "Paper"],
    correct: 2,
    explanation:
  ...
  },
  {
    ...
    correct: 0,
    explanation:
      "f = 1/(2π√LC). With max C (500pF): f = 2.25MHz, with min C (50pF): f = 7.1MHz",
  ...
  },
  {
    ...
    image: "",
    options: ["485 ohms", "970 ohms", "242 ohms", "1940 ohms"],
    correct: 1,
  ...
  },
  {
    ...
    question:
      "Two 10mH inductors are connected in parallel. What is the total inductance?",
    image: "",
    options: ["20mH", "10mH", "5mH", "2.5mH"],
    correct: 2,
    explanation:
      "Parallel inductors: 1/Ltotal = 1/L1 + 1/L2, so Ltotal = 10/2 = 5mH",
  ...
  },
  {
    ...
    question:
      "What is the phase relationship between voltage and current in a pure inductive circuit?",
    image: "",
    options: [
      "Voltage leads current by 90°",
      "Current leads voltage by 90°",
    ...
    correct: 0,
    explanation:
      "In inductive circuits, voltage leads current by 90° (or current lags voltage by 90°)",
    lookup: "See AC theory and phase relationships",
    syllabus: "3b",
  },
  {
    ...
    correct: 1,
    explanation:
      "Energy stored in an inductor = ½LI². Energy is proportional to the square of the current",
  ...
  },
  {
    ...
    question:
      "A 100mH inductor carries 2A of current. The current is switched off in 1ms. What is the back EMF generated?",
    image: "",
    options: ["100V", "200V", "50V", "400V"],
    correct: 1,
  ...
  },
  {
    ...
    question:
      "What happens to the inductance of a coil if the number of turns is doubled?",
    image: "",
    options: [
      "Inductance doubles",
    ...
    correct: 2,
    explanation:
      "Inductance is proportional to N². If turns double, inductance increases by 2² = 4 times",
  ...
  },
  {
    ...
    question:
      "Which core material would give the highest inductance for an RF choke at 14MHz?",
    image: "",
    options: [
      "Air core",
      "Iron powder (Type 2)",
    ...
    correct: 2,
    explanation:
      "Type 43 ferrite has high permeability and is designed for HF applications like 14MHz",
  ...
  },
  {
    ...
    question:
      "What is the Q factor of an inductor with reactance 628Ω and resistance 10Ω at its operating frequency?",
    image: "",
    options: ["6.28", "62.8", "628", "0.0159"],
    correct: 1,
  ...
  },
  {
    ...
    correct: 1,
    explanation:
      "To DC (f=0), XL = 2πfL = 0, so an inductor acts as a short circuit (very low impedance)",
  ...
  },
  {
    ...
    correct: 2,
    explanation:
      "In resistive circuits, voltage and current are always in phase (0° phase difference)",
  ...
  },
  {
    ...
    question:
      "A series RLC circuit has R=50Ω, XL=80Ω, XC=30Ω. What is the total impedance?",
    image: "",
    options: ["160Ω", "70.7Ω", "100Ω", "50Ω"],
    correct: 1,
    explanation:
      "Z = √[R² + (XL-XC)²] = √[50² + (80-30)²] = √[2500 + 2500] = 70.7Ω",
  ...
  },
  {
    ...
    question:
      "What is the phase angle in the series RLC circuit with R=50Ω, XL=80Ω, XC=30Ω.?",
    image: "",
    options: ["0°", "30°", "45°", "60°"],
    correct: 2,
    explanation:
      "Phase angle = arctan[(XL-XC)/R] = arctan[(80-30)/50] = arctan(1) = 45°",
  ...
  },
  {
    ...
    question:
      "In an AC circuit, what is the power factor when the phase angle is 60°?",
    image: "",
  ...
  },
  {
    ...
    correct: 3,
    explanation:
      "Pure reactances (L or C) consume no real power - they store and return energy each cycle",
  ...
  },
  {
    ...
    question:
      "A circuit has 100W true power and 200W reactive power. What is the apparent power?",
    image: "",
    options: ["141VA", "224VA", "300VA", "100VA"],
    correct: 1,
    explanation:
      "Apparent power = √(P² + Q²) = √(100² + 200²) = √50000 = 224VA",
  ...
  },
  {
    ...
    question:
      "At what frequency does a 10μH inductor have the same reactance as a 100pF capacitor?",
    image: "",
    options: ["1.59MHz", "5.03MHz", "15.9MHz", "50.3MHz"],
    correct: 1,
    explanation:
      "XL = XC when 2πfL = 1/(2πfC). Solving: f = 1/(2π√LC) = 1/(2π√(10×10⁻⁶ × 100×10⁻¹²)) = 5.03MHz",
  ...
  },
  {
    ...
    correct: 1,
    explanation:
      "A lagging current is shown with the current phasor rotated clockwise (behind) the voltage phasor",
  ...
  },
  {
    ...
    question:
      "ESTIMATE (don't calculate): 220pF at 7MHz. Which range is the reactance in?",
    image: "",
    options: ["1-10 ohms", "10-100 ohms", "100-1000 ohms", "1000-10000 ohms"],
    correct: 2,
    explanation:
      "Using 1pF at 1GHz ≈ 160Ω. 220pF ≈ 200x more cap → 160/200 = 0.8Ω. 7MHz vs 1GHz = 1000/7 ≈ 140x. So 0.8 × 140 ≈ 112Ω. Exact: 103.35Ω",
  ...
  },
  {
    ...
    image: "",
    options: ["160 ohms", "1600 ohms", "16 ohms", "16000 ohms"],
    correct: 1,
    explanation:
      "Using 1nF at 1MHz ≈ 160Ω. 10nF = 10x more cap → 160/10 = 16Ω. But 10kHz = 1/100 of 1MHz → 16 × 100 = 1600Ω. Exact: 1592Ω",
  ...
  },
  {
    ...
    image: "",
    options: ["50 ohms", "160 ohms", "500 ohms", "1600 ohms"],
    correct: 1,
    explanation:
      "Using 1pF at 1GHz ≈ 160Ω. 47pF ≈ 50x more cap → 160/50 = 3.2Ω. 21MHz vs 1GHz = 1000/21 ≈ 50x. So 3.2 × 50 ≈ 160Ω. Exact: 161.25Ω",
  ...
  },
  {
    ...
    correct: 3,
    explanation:
      "Using 1μF at 1kHz ≈ 160Ω. Same capacitance, but 50Hz = 1/20 of 1kHz → 160 × 20 = 3200Ω. Wait, that's too high! Let me recalculate: 160Ω × (1000/50) = 160 × 20 = 3200Ω.  Exact: 3183Ω",
  ...
  },
  {
    ...
    image: "",
    options: ["35 ohms", "70 ohms", "140 ohms", "280 ohms"],
    correct: 0,
    explanation:
      "Using 1pF at 1GHz ≈ 160Ω. 330pF ≈ 300x more → 160/300 ≈ 0.5Ω. 14MHz vs 1GHz = 1000/14 ≈ 70x. So 0.5 × 70 ≈ 35Ω. Exact: 34.45Ω",
    lookup: "",
    syllabus: "0",
  },
  {
    ...
    image: "",
    options: ["0.5 ohms", "5 ohms", "50 ohms", "500 ohms"],
    correct: 0,
    explanation:
      "Using 1nF at 1MHz ≈ 160Ω. 2.2nF ≈ 2x more cap → 160/2 = 80Ω. 144MHz vs 1MHz = 144x higher freq → 80/144 ≈ 0.6Ω. Exact: 0.5024Ω",
  ...
  },
  {
    ...
    image: "",
    options: ["220pF", "470pF", "1nF", "2.2nF"],
    correct: 1,
    explanation:
      "Work backwards: need 50Ω at 7MHz. Using reference scaling, this suggests about 470pF. Check: 470pF at 7MHz gives 48.38Ω (very close to 50Ω target)",
  ...
  },
  {
    ...
    image: "",
    options: ["0.01-0.1 ohms", "0.1-1 ohms", "1-10 ohms", "10-100 ohms"],
    correct: 3,
    explanation:
      "Using 1μF at 1kHz ≈ 160Ω. 100μF = 100x more cap → 160/100 = 1.6Ω. 50Hz = 1/20 of 1kHz → 1.6 × 20 = 32Ω.  Exact: 31.83Ω",
    lookup: "",
    syllabus: "0",
  },
  {
    ...
    question:
      "A series LC circuit has L=10μH and C=100pF. What is the resonant frequency?",
    image: "",
    options: ["1.59MHz", "5.03MHz", "15.9MHz", "50.3MHz"],
    correct: 1,
  ...
  },
  {
    ...
    question:
      "At resonance, what is the impedance of a series LC circuit (ignoring resistance)?",
    image: "",
    options: ["Zero", "Infinite", "Equal to XL", "Equal to XC"],
    correct: 0,
    explanation:
      "At resonance, XL = XC and they cancel out, leaving Z = 0 (ignoring resistance)",
  ...
  },
  {
    ...
    question:
      "At resonance, what is the impedance of a parallel LC circuit (ignoring resistance)?",
    image: "",
    options: ["Zero", "Infinite", "Equal to XL", "Equal to XC"],
    correct: 1,
    explanation:
      "At resonance in a parallel LC circuit, the impedance is maximum (theoretically infinite, ignoring resistance)",
  ...
  },
  {
    ...
    question:
      "A tuned circuit has Q=100 and resonates at 7MHz. What is the bandwidth?",
    image: "",
    options: ["35kHz", "70kHz", "140kHz", "700kHz"],
    correct: 1,
  ...
  },
  {
    ...
    question:
      "What happens to the resonant frequency if the capacitance is increased by 4 times?",
    image: "",
    options: [
    ...
    correct: 2,
    explanation:
      "f₀ ∝ 1/√C. If C increases by 4x, then √C increases by 2x, so frequency decreases by 2x",
  ...
  },
  {
    ...
    question:
      "In a series RLC circuit at resonance, where does the maximum voltage appear?",
    image: "",
    options: [
      "Across the resistor",
    ...
    correct: 1,
    explanation:
      "At resonance, voltage across L or C can be Q times the supply voltage, much higher than across R",
  ...
  },
  {
    ...
    question:
      "A crystal oscillator has a series resonant frequency of 10MHz and parallel resonant frequency of 10.001MHz. This crystal would typically be used in:",
    image: "",
    options: [
      "Series mode only",
      "Parallel mode only",
    ...
    correct: 2,
    explanation:
      "This small frequency difference is normal for crystals. They can operate in either mode depending on circuit design",
  ...
  },
  {
    ...
    question:
      "What is the phase relationship between voltage and current in a series LC circuit below the resonant frequency?",
    image: "",
    options: [
    ...
    correct: 0,
    explanation:
      "Below resonance, XC > XL, so the circuit acts capacitively and current leads voltage",
  ...
  },
  {
    ...
    question:
      "A parallel LC circuit has L=1μH and is tuned to 100MHz. What value of C is needed?",
    image: "",
    options: ["2.53pF", "25.3pF", "253pF", "2.53nF"],
    correct: 0,
    explanation:
      "Rearranging f₀ = 1/(2π√LC): C = 1/(4π²f₀²L) = 1/(4π² × (100×10⁶)² × 1×10⁻⁶) = 2.53pF",
  ...
  },
  {
    ...
    correct: 2,
    explanation:
      "Q = XL/R (or XC/R). The resistance of the components, especially the inductor, determines the Q",
  ...
  },
  {
    ...
    question:
      "What is the typical frequency stability of a crystal oscillator compared to an LC oscillator?",
    image: "",
    options: [
      "About the same",
      "10 times better",
    ...
    correct: 3,
    explanation:
      "Crystal oscillators typically have frequency stability 1000 times better than LC oscillators",
  ...
  },
  {
    ...
    question:
      "A crystal has a series resonant frequency of 10.000MHz and a parallel resonant frequency of 10.003MHz. What is this difference called?",
    image: "",
    options: [
      "Frequency drift",
    ...
    correct: 1,
    explanation:
      "The difference between series and parallel resonant frequencies defines the frequency pulling range",
  ...
  },
  {
    ...
    question:
      "What is the equivalent circuit of a crystal near its resonant frequency?",
    image: "",
    options: [
    ...
    correct: 2,
    explanation:
      "A crystal is equivalent to a series LCR circuit (motional arm) in parallel with the holder capacitance",
  ...
  },
  {
    ...
    correct: 1,
    explanation:
      "Temperature is the dominant factor affecting crystal frequency. Most crystals have temperature coefficients specified in ppm/°C",
  ...
  },
  {
    ...
    correct: 0,
    explanation:
      "TCXO stands for Temperature Compensated Crystal Oscillator - uses compensation circuits to reduce temperature drift",
  ...
  },
  {
    ...
    question:
      "A 10MHz crystal is used in a circuit that presents a load capacitance of 20pF. The crystal is specified for 32pF load. How will this affect the frequency?",
    image: "",
    options: [
    ...
    correct: 0,
    explanation:
      "Lower load capacitance than specified causes the crystal to oscillate at a higher frequency",
  ...
  },
  {
    ...
    correct: 3,
    explanation:
      "Crystal resonators have extremely high Q factors, typically 10,000 to 100,000, much higher than LC circuits",
  ...
  },
  {
    ...
    correct: 2,
    explanation:
      "Crystals typically show an initial frequency decrease (aging) that slows over time and eventually stabilizes",
  ...
  },
  {
    ...
    question:
      "At what frequency mode does a 20MHz fundamental crystal typically operate?",
    image: "",
    options: [
    ...
    correct: 1,
    explanation:
      "Crystals above about 15MHz typically use overtone operation. A 20MHz crystal usually operates on the 3rd overtone",
  ...
  },
  {
    ...
    correct: 1,
    explanation:
      "OCXO (Oven Controlled Crystal Oscillator) maintains the crystal at a constant elevated temperature to minimize frequency drift",
  ...
  },
  {
    ...
    question:
      "What is the typical forward voltage drop of a silicon diode at room temperature?",
    image: "",
    options: ["0.3V", "0.7V", "1.2V", "2.1V"],
    correct: 1,
    explanation:
  ...
  },
  {
    ...
    question:
      "In an NPN transistor, what is the normal bias condition for amplifier operation?",
    image: "",
    options: [
  ...
  },
  {
    ...
    question:
      "What is the approximate current gain (hfe or β) of a typical small signal transistor?",
    image: "",
    options: ["1 to 10", "10 to 50", "50 to 500", "500 to 5000"],
    correct: 2,
    explanation:
  ...
  },
  {
    ...
    question:
      "A Zener diode with a 5.1V rating is used in a voltage regulator circuit. What is its primary function?",
    image: "",
    options: [
      "Rectification",
  ...
  },
  {
    ...
    question:
      "What type of transistor configuration provides voltage gain but no current gain?",
    image: "",
    options: [
      "Common emitter",
  ...
  },
  {
    ...
    question:
      "What is the main advantage of a MOSFET over a bipolar transistor?",
    image: "",
    options: [
  ...
  },
  {
    ...
    question:
      "A LED has a forward voltage of 2.1V and needs 20mA current. What series resistor is needed with a 12V supply?",
    image: "",
    options: ["220Ω", "390Ω", "495Ω", "680Ω"],
    correct: 2,
    explanation:
  ...
  },
  {
    ...
    question:
      "What happens to the resistance of a thermistor (NTC type) as temperature increases?",
    image: "",
    options: [
  ...
  },
  {
    ...
    question:
      "In a Class A amplifier, what percentage of the input cycle does the transistor conduct?",
    image: "",
  ...
  },
  {
    ...
    question:
      "What is the primary cause of thermal runaway in power transistors?",
    image: "",
    options: [
  ...
  },
  {
    ...
    question:
      "A transformer has a primary winding of 240 turns and a secondary of 60 turns. What is the turns ratio?",
    image: "",
    options: ["1:4", "4:1", "1:0.25", "0.25:1"],
    correct: 1,
  ...
  },
  {
    ...
    question:
      "Using a transformer with a primary winding of 240 turns and a secondary of 60 turns, if 240V AC is applied to the primary, what is the secondary voltage?",
    image: "",
    options: ["15V", "60V", "240V", "960V"],
    correct: 1,
  ...
  },
  {
    ...
    question:
      "If the secondary of the transformer, with a primary winding of 240 turns and a secondary of 60 turns supplies 2A, what is the primary current (assuming 100% efficiency)?",
    image: "",
    options: ["0.5A", "2A", "4A", "8A"],
    correct: 0,
    explanation:
      "Ip = Is × (Ns/Np) = 2 × (60/240) = 2 × 0.25 = 0.5A. Power in = Power out, so high voltage/low current on primary",
  ...
  },
  {
    ...
    question:
      "What is the impedance transformation ratio of a transformer with a turns ratio of 5:1?",
    image: "",
  ...
  },
  {
    ...
    question:
      "A 50Ω load is connected to the secondary of a 3:1 transformer. What impedance does the primary see?",
    image: "",
    options: ["5.6Ω", "16.7Ω", "150Ω", "450Ω"],
    correct: 3,
  ...
  },
  {
    ...
    question:
      "What type of core material is best for transformers operating at RF frequencies?",
    image: "",
    options: ["Laminated steel", "Solid iron", "Ferrite", "Air core"],
    correct: 2,
    explanation:
      "Ferrite cores have low losses at RF frequencies, unlike steel which has high eddy current losses at RF",
  ...
  },
  {
    ...
    question:
      "What is the primary cause of power loss in an iron-core transformer at 50Hz?",
    image: "",
    options: [
    ...
    correct: 1,
    explanation:
      "At mains frequencies, core losses (hysteresis and eddy currents) are typically the dominant loss mechanism",
  ...
  },
  {
    ...
    question:
      "A center-tapped transformer secondary provides 25V from each half to center tap. What voltage appears across the full secondary?",
    image: "",
    options: ["25V", "35.4V", "50V", "70.7V"],
    correct: 2,
    explanation:
      "The full secondary voltage is twice the center-tap voltage: 2 × 25V = 50V",
  ...
  },
  {
    ...
    question:
      "What is the main advantage of a toroidal transformer over a conventional E-I core transformer?",
    image: "",
    options: [
      "Lower cost",
    ...
    correct: 2,
    explanation:
      "Toroidal transformers have a closed magnetic path, resulting in much lower external magnetic field leakage",
  ...
  },
  {
    ...
    question:
      "An audio transformer is used to match a 8Ω speaker to a 2000Ω tube amplifier output. What turns ratio is needed?",
    image: "",
    options: ["1:15.8", "15.8:1", "1:250", "250:1"],
    correct: 1,
    explanation:
      "Turns ratio = √(Zp/Zs) = √(2000/8) = √250 = 15.8:1 (primary to secondary)",
  ...
  },
  {
    ...
    question:
      "A half-wave rectifier uses a transformer with 25V RMS secondary. What is the peak DC output voltage (ignoring diode drop)?",
    image: "",
    options: ["25V", "35.4V", "50V", "70.7V"],
    correct: 1,
  ...
  },
  {
    ...
    question:
      "What is the main advantage of a full-wave bridge rectifier over a center-tap full-wave rectifier?",
    image: "",
    options: [
    ...
    correct: 1,
    explanation:
      "Bridge rectifiers use the full transformer secondary voltage, while center-tap circuits only use half at a time",
  ...
  },
  {
    ...
    question:
      "In a full-wave rectifier fed from 50Hz mains, what is the ripple frequency?",
    image: "",
    options: ["25Hz", "50Hz", "100Hz", "200Hz"],
    correct: 2,
    explanation:
      "Full-wave rectification produces two pulses per AC cycle, so ripple frequency = 2 × 50Hz = 100Hz",
  ...
  },
  {
    ...
    question:
      "What is the purpose of the reservoir capacitor in a power supply?",
    image: "",
    options: [
      "Voltage regulation",
      "Current limiting",
    ...
    correct: 2,
    explanation:
      "The reservoir (filter) capacitor smooths the pulsating DC from the rectifier, reducing ripple",
  ...
  },
  {
    ...
    question:
      "A Zener diode regulator has a 12V Zener with 10mA Zener current. The series resistor is 330Ω and input voltage is 18V. What is the maximum load current?",
    image: "",
    options: ["8.2mA", "18.2mA", "28.2mA", "54.5mA"],
    correct: 0,
    explanation:
  ...
  },
  {
    ...
    question:
      "What is the main advantage of a switching power supply over a linear regulator?",
    image: "",
    options: [
      "Lower cost",
      "Better regulation",
    ...
    correct: 2,
    explanation:
      "Switching supplies are much more efficient (80-95%) compared to linear regulators (50-60% typical)",
  ...
  },
  {
    ...
    question:
      "In a three-terminal voltage regulator (like 7812), what is the typical dropout voltage?",
    image: "",
    options: ["0.7V", "2V", "5V", "12V"],
    correct: 1,
    explanation:
      "Three-terminal regulators typically need about 2V headroom (dropout voltage) above the regulated output",
  ...
  },
  {
    ...
    question:
      "What type of transformer is typically used in a switching power supply?",
    image: "",
    options: [
    ...
    correct: 2,
    explanation:
      "Switching supplies use high-frequency transformers (typically 20-100kHz) which are much smaller and lighter",
  ...
  },
  {
    ...
    question:
      "A power supply has 2% regulation. If the no-load voltage is 12.5V, what is the full-load voltage?",
    image: "",
    options: ["12.0V", "12.25V", "12.75V", "13.0V"],
    correct: 1,
    explanation:
      "2% regulation means 2% drop from no-load to full-load: 12.5V - (12.5 × 0.02) = 12.5 - 0.25 = 12.25V",
  ...
  },
  {
    ...
    question:
      "What safety feature is essential in all mains-powered equipment?",
    image: "",
    options: [
    ...
    correct: 2,
    explanation:
      "Earth/ground connection is essential for safety - it provides a path for fault currents and prevents chassis from becoming live",
