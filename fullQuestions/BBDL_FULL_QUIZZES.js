const BBDL_FULL_QUIZZES = [
  ...
  },
  {
    ...
    syllabus: "2b.1",
    examStrategy: "2",
    examStrategyNotes: "Update these notes when you next try this out.",
    examCalculation: "1",
    exam_NOT: false,
  },
  {
  ...
  },
  {
    ...
    examStrategy: "3",
    examStrategyNotes:
      "1. Draw the circuit with values in full 2. notes where voltages are the sam or where current splits 3. Try an estimate, ignoring high values in parallel with low values.",
    examCalculation: "3",
    exam_NOT: false,
  },
  {
