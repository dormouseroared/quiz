const BBDL_FULL_QUIZZES = [
  ...
  },
  {
    ...
    syllabus: "8a.1",
    examStrategy: 2,
    examStrategyNotes: "Think SAFETY!!",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
    ...
    syllabus: "8a.2",
    examStrategy: 2,
    examStrategyNotes: "Should be obvious.",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
    ...
    syllabus: "8a.6",
    examStrategy: 2,
    examStrategyNotes: "Read through and get this right!",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
    ...
    syllabus: "8d.1",
    examStrategy: 2,
    examStrategyNotes: "It's that well known International Commission again.",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
  ...
  },
  {
    ...
    examStrategy: 3,
    examStrategyNotes:
      "Just take it steady one step at a time, remembering those rules about voltage dividers, and current etc",
    examCalculation: 3,
    exam_NOT: false,
  },
  {
...
materials, whereas polythene is definitely a man-made sheet material.`,
  ...
  },
  {
    ...
    syllabus: "7h.1",
    examStrategy: 2,
    examStrategyNotes: "Drill if needed.",
    examCalculation: 0,
    exam_NOT: true,
  ...
  },
  {
    ...
    examStrategy: 2,
    examStrategyNotes:
      "Valves could always be mentioned a couple of times, so choose the best answer to the question.",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
  ...
  },
  {
    ...
    examStrategy: 3,
    examStrategyNotes:
      "Compared to a fixed location, what is an extra safety risk?.",
    examCalculation: 0,
    exam_NOT: false,
  },
  {
  ...
  },
  {
    ...
    examStrategy: 3,
    examStrategyNotes:
      "Confirm the formula on EX309. Then plug the numbers in and get the answer.",
    examCalculation: 3,
    exam_NOT: false,
  },
  {
  ...
  },
  {
    ...
    examStrategyNotes: `
      ...
      there's an output from the Emitter (via the capacitor), and an input to the Base.
      Since we need 4 connections (two pairs really but only 3 connections) to get from input to output, the 
  ...
  },
  {
    ...
    examStrategy: 4,
    examStrategyNotes:
      "Peak Inverse Voltage (PIV) rating must cover at least peak to peak voltage, especially in a half wave rectifier.",
    examCalculation: 0,
    exam_NOT: false,
    clipId: "week04-clip-003a",
  },
  {
...
viable answer, although harmonics would also be likely.`,
...
`,
  ...
  },
  {
    ...
    'c' would attenuate all HF signals, making the external amplifier rather pointless. 
...
dipole to be:`,
    ...
    correct: 1,
    explanation: `Use λ = 300/MHz to find 1λ, halve it to give λ/2 then multiply by 
...
which is what we want for 2m FM calling.`,
    ...
    examStrategy: 4,
    examStrategyNotes:
      "Watch out for the mention of the frequency in the question, and spot the gap! It is not a Buffer Amplifier! If this was a paper exam, we would use a highlighter on the key words or numbers. The workaround has to be to WRITE DOWN the relevant facts, including 145MHz, 16.17MHz, and x3. Also at this level the block diagrams are not fixed, so examiners can make them up to suit the question!",
    examCalculation: 2,
    exam_NOT: false,
    tagged: true,
    obsidianURL:
...
hundreds of trivial hazards that need no mitigating action. `,
    ...
    examStrategy: 3,
    examStrategyNotes:
      "It looked straightforward, but a subtle play on words is hard to beat. The keywords are definitely the 'significant findings'. So again, the key phrase that must leap out of the page is: <br>SIGNIFICANT FINDINGS_SIGNIFICANT FINDINGS_SIGNIFICANT FINDINGS_SIGNIFICANT FINDINGS_SIGNIFICANT FINDINGS_SIGNIFICANT FINDINGS_SIGNIFICANT FINDINGS_",
    examCalculation: 0,
    exam_NOT: false,
    tagged: true,
    obsidianURL:
...
o So, voltage across 9k = I x R = 3.48v`,
  ...
  {
    source: "BBDL QUIZ WEEK10 Q01",
    question: `Under free space conditions, a radio signal's Power Flux Density, (measured in Watts per square metre):`,
    image: "",
    options: [
      "Reduces in a linear fashion with increasing distance from the transmitting antenna",
      "Reduces according to the inverse square law with increasing distance from the transmitting antenna",
      "Remains constant at all distances",
      "Is measured in Volts per square metre",
    ],
    correct: 1,
    explanation: `The Power Flux Density of a radio signal is a measure of the energy being
radiated. The signal spreads out in all directions and at any point the Power Flux Density is measured in
Watts per square metre (Watts per metre squared). Because the signal is spreading out the signal strength reduces with
distance, obeying the inverse square law.`,
    lookup: "See page(s) 78 of the Full Licence Manual",
    syllabus: "5a.1",
    reference: "",
    examStrategy: 2,
    examStrategyNotes: "Shoukld be well drilled",
    examCalculation: 0,
    exam_NOT: false,
    tagged: false,
    obsidianURL: "",
  ...
  {
    source: "BBDL QUIZ WEEK10 Q02",
    question: `As you move away from a transmitting antenna the field strength is:`,
    image: "",
    options: [
    ...
    correct: 2,
    explanation: `A few words of explanation.... If something is proportional to another item as
one increases so does the other. We know from Foundation that signals get weaker as you increase the
distance from the transmitter, so ‘a’ and ‘b’ cannot be correct. The formula for Field Strength is on your
Formula Sheet and distance is on the bottom without any square root, so the top line is inversely
proportional to the distance; double the distance and you half the Field Strength. Field Strength is
covered in two places in the textbook, page 85 of the textbook is the more detailed, and should let you
know that ‘c’ is the correct answer.`,
    lookup: "See page(s) 78, 85-86 of the Full Licence Manual",
    syllabus: "5a.1",
    reference: "",
    examStrategy: 2,
    examStrategyNotes:
      "Should be well drilled. Check EX309 for the Field Strength formula for E.",
    examCalculation: 1,
    exam_NOT: false,
    tagged: false,
    obsidianURL: "",
  ...
  {
    source: "BBDL QUIZ WEEK10 Q03",
    question: `For best reception when receiving a circularly polarised signal your antenna should:`,
    image: "",
    options: [
      "Be a discone antenna",
      "Be circularly polarised with a ‘right hand thread’",
      "Be circularly polarised with a ‘left hand thread’",
      "Be circularly polarised with the same thread sense as the transmitter",
    ],
    correct: 3,
    explanation: `Circular polarisation can be right or left hand ‘thread’ but if you do not get the
TX and Rx ‘thread’ the same you will incur massive signal attenuation. ‘d’ would seem to be the correct
answer in this case.`,
    lookup: "See page(s) 78-79 of the Full Licence Manual",
    syllabus: "5a.3",
    reference: "",
    examStrategy: 2,
    examStrategyNotes: "Another well drilled bit.",
    examCalculation: 0,
    exam_NOT: false,
    tagged: false,
    obsidianURL: "",
  ...
  {
    source: "BBDL QUIZ WEEK10 Q04",
    question: `A solar flare emits x-rays, UV rays and charged particles, this causes:`,
    image: "",
    options: [
      "A decrease in the Ionisation of the D Layer",
      "An increase in the D layer absorption",
      "An increase in HF Communication ability",
      "An increase in UHF communication ability",
    ],
    correct: 1,
    explanation: `After solar flare activity the D layer ionisation and absorption increases. The
highly ionised D layer can cause signals to be lost in a phenomenon known as Sudden Ionospheric
Disturbance (SID) (also known as Dellinger Fade Out). The D layer will take several hours after this event
to start to recover.`,
    lookup: "See page(s) 81 of the Full Licence Manual",
    syllabus: "5b.1",
    reference: "",
    examStrategy: 4,
    examStrategyNotes: "Still a bit tricky, so make sure this is well drilled.",
    examCalculation: 0,
    exam_NOT: false,
    tagged: false,
    obsidianURL: "",
  ...
  {
    source: "BBDL QUIZ WEEK10 Q05",
    question: `The ‘critical frequency’ is the:`,
    image: "",
    options: [
      "Lowest frequency returned from the horizon",
      "Optimum useable frequency for a given propagation path",
      "Most stable frequency for day and night use",
      "Highest frequency that is reflected when a wave strikes an ionised layer vertically",
    ],
    correct: 3,
    explanation: `A matter of recalling the definition, which has the full title of ‘critical frequency
of vertical incidence’, making it obvious (?) that ‘d’ is the correct answer.`,
    lookup: "See page(s) 80 of the Full Licence Manual",
    syllabus: "5b.2",
    reference: "",
    examStrategy: 3,
    examStrategyNotes:
      "Always think it is the Critical Frequency of Vertical Incidence...",
    examCalculation: 0,
    exam_NOT: false,
    tagged: false,
    obsidianURL: "",
  ...
  {
    source: "BBDL QUIZ WEEK10 Q06",
    question: `NVIS propagation occurs when:`,
    image: "",
    options: [
      "A skywave is inverted when reflected from a near vertical object in the radiation path",
      "A skywave is reflected near to vertically back from the ionosphere",
      "Nominal vertical polarised waves are subject to Ionospheric skip",
      "Normal variable inversion skywaves provide unexpected DX",
    ],
    correct: 1,
    explanation: `There is no real difference between NVIS and conventional skywave
propagation, other than the angle of radiation: NVIS is ‘Near Vertical Incidence Skywave’ and for
conventional long-range (DX) skywave propagation we need ‘low angle, or ‘near horizontal’ radiation. ‘a’
mentions a “near vertical object” which is not correct so not ’a’. ‘b’ sounds spot on. ‘c’ is wrong because
the polarisation is not relevant to NVIS, although a horizontally polarised antenna radiating upwards is
more what is needed. Lastly ‘d’ is just a string of words with a ‘fake’ NVIS acronym; best ignored.`,
    lookup: "See page(s) 81 of the Full Licence Manual",
    syllabus: "5b.3",
    reference: "",
    examStrategy: 3,
    examStrategyNotes: "Drill again.",
    examCalculation: 0,
    exam_NOT: false,
    tagged: false,
    obsidianURL: "",
  ...
  {
    source: "BBDL QUIZ WEEK10 Q07",
    question: `If you hear DX signals on the 144MHz band and they sound ‘watery’ with rapid fluttering in the signal strength, what is the most likely mode of propagation?`,
    image: "",
    options: [
      "Reflection from a changing ionosphere",
      "Reflection from a passing aircraft",
      "Reflection from the Moon",
      "Reflection from an Aurora",
    ],
    correct: 3,
    explanation: `The clue to the type of propagation is the thin, watery sound that will probably
be accompanied by fluttering (due to the moving curtain nature of the ionised gasses making up the
aurora, particularly if the signals are emanating from the North East quadrant. Once you have heard
auroral propagation you will easily recognise it again. By comparison, VHF reflections from a changing
ionosphere tend to be via Sporadic E, and sound like perfectly clear strong signals, so not ‘a’. Reflections
from passing aircraft are short lived, are subject to flutter, but are not ‘watery’, so not ‘b’. Amateur radio
signals reflecting from the moon are likely to be weak and subject to Doppler shift but should not sound
‘watery’, so not ‘c’.`,
    lookup: "See page(s) 81 of the Full Licence Manual",
    syllabus: "5c.3",
    reference: "",
  ...
  {
    source: "BBDL QUIZ WEEK10 Q08",
    question: `EME propagation generally requires operators to use high power, high gain antennas and high gain receiver amplifiers because:`,
    image: "",
    options: [
      "The Moon is a poor reflector of radio waves and low power HF signals cannot propagate over long distances",
      "HF signals are absorbed by the D layer and the Moon is a poor reflector of radio waves",
      "There is high path loss and the Moon is a poor reflector of radio waves",
      "There is high path loss and HF signals are absorbed by the D layer",
    ],
    correct: 2,
    explanation: `‘a’ is half correct, the Moon is a poor reflector of RF but HF QRP signals can
propagate over long distances, so not that one. ‘b’ is true, but has nothing to do with why the station
described in the question is used. ‘c’ looks good with a long path with some serious losses, and the poor
reflector of RF. ‘d’ is true, but has nothing to do with why the station described in the question is used.`,
    lookup: "See page(s) 81-82 of the Full Licence Manual",
    syllabus: "5c.3",
    reference: "",
    examStrategy: 4,
    examStrategyNotes: "Tricky one!",
    examCalculation: 0,
    exam_NOT: false,
    tagged: false,
    obsidianURL: "",
  ...
  {
    source: "BBDL QUIZ WEEK10 Q09",
    question: `Why is it not possible to say that a vertical or horizontal antenna will be best on any given ionospheric propagation path?`,
    image: "",
    options: [
      "Ionospheric reflection can change the polarisation",
      "Vertical and horizontal antennas do not have any impact on HF polarisation",
      "Attenuation in the pathway removes any advantage that either polarisation may have",
      "The direction of the propagation (e.g. North/South versus East/West) has an effect on polarisation",
    ],
    correct: 0,
    explanation: `Refraction of a radio signal in the ionosphere is often accompanied by changes
in polarisation. ‘b’ is gobbledegook because a vertical or horizontal will clearly have some impact on
polarisation. ‘c’ is just not true; path loss affects any polarisation. ‘d’ is also plain wrong because the
direction of propagation has no effect on polarisation.`,
    lookup: "See page(s) x of the Full Licence Manual",
    syllabus: "5b.4",
    reference: "",
    examStrategy: 3,
  ...
  {
    source: "BBDL QUIZ WEEK10 Q10",
    question: `Galactic Noise can be defined as:`,
    image: "",
    options: [
      "Amateur transmissions that are sent into deep space to test Galactic propagation",
      "Intense electromagnetic interference with a signal strength greater than S9",
      "Regular pulses of radiation emanating from outside our own galaxy",
      "Noise that originates outside the Earth’s atmosphere",
    ],
    correct: 3,
    explanation: `‘a’ sounds a bit like a mission for Star Trek and I am unaware of any galactic
propagation so not ‘a’! Intense interference above S9 can occur and it may sound “galactic” but no, ‘b’ is
just fiction. Pulses of radiation do emanate from outside our galaxy but galactic noise can also come
from within our galaxy, so not ‘c’. ‘d’ best fits the bill, and is what the syllabus says.`,
    lookup: "See page(s) 82 of the Full Licence Manual",
    syllabus: "5d.1",
    reference: "",
    examStrategy: 3,
    examStrategyNotes: "Repeat after me, it is what the syllabus says.",
    examCalculation: 0,
    exam_NOT: false,
    tagged: false,
    obsidianURL: "",
  ...
  {
    source: "BBDL QUIZ WEEK10 Q11",
    question: `Circular polarisation is most often used for:`,
    image: "",
    options: [
      "NVIS propagation",
      "Sporadic E propagation",
      "Amateur Maritime Mobile Communications across salt water",
      "Communications between terrestrial amateur radio stations and amateur satellites",
    ],
    correct: 3,
    explanation: `answer. Circular polarisation can be used for whatever you fancy but it is most
commonly used for satellite communications. NVIS work is generally from low dipoles generating
horizontal polarisation; some say the closer to the ground the better, so not ‘a’. Sporadic E can be
extremely intense and just about any polarisation will make the QSO, especially as it may be twisted as it
is refracted from the ionosphere, so not ‘b’. Similarly, contacts made across saltwater tend to be vertical
or horizontal, not usually circular polarised, so not ‘c’.`,
    lookup: "See page(s) 78-79 of the Full Licence Manual",
    syllabus: "5a.3",
    reference: "",
    examStrategy: 3,
    examStrategyNotes:
      "Satellites and circular go together like banana and sandwich.",
    examCalculation: 0,
    exam_NOT: false,
    tagged: false,
    obsidianURL: "",
  ...
  {
    source: "BBDL QUIZ WEEK10 Q12",
    question: `Which of the following is a way of expressing losses over a path between a radio transmitter and a radio receiver?`,
    image: "",
    options: [
      "The Return Loss",
      "The Link Budget",
      "The Velocity Factor",
      "The Antenna Termination Factor",
    ],
    correct: 1,
    explanation: `Straightforward memory test. The Link Budget is the combined losses of
everything between the transmitter output socket and the receiver input socket. Return Loss is a way of
describing the match, or mismatch in an antenna system, so not ‘a’. Velocity Factor describes the
difference between a theoretical wavelength and the real world wavelength in a cable, so not ‘c’. ‘d’ is a
made up term, so not that one.`,
    lookup: "See page(s) 103 of the Full Licence Manual",
    syllabus: "5d.2",
    reference: "",
    examStrategy: 3,
...
need Ofcom’s clearance. `,
    ...
    examStrategy: 3,
    examStrategyNotes:
      "Another EX309 cracker from the Notice of Coordination, right at the very end in the Ofcom Coordination Process. WE covered this in the video tutorial.",
    examCalculation: 0,
    exam_NOT: false,
    tagged: false,
    obsidianURL: "",
...
where you should find that VDRs are in fact Voltage Dependant Resistors, making ‘a’ the correct answer.`,
    ...
    reference: "",
    examStrategy: 3,
    examStrategyNotes: "Commit to memory (drill).",
    examCalculation: 0,
    exam_NOT: false,
    tagged: false,
    obsidianURL: "",
...
contact for formal complaints about EMC problems caused by amateur radio transmissions, so not ‘d’. `,
  ...
  {
    source: "BBDL QUIZ WEEK13 Q01",
    question: `To make a 100μA meter movement read up to 100V DC you would add:`,
    image: "",
    options: [
      "A 100kΩ resistor in series",
      "A 1MΩ resistor in series",
      "A 100kΩ resistor in parallel",
...
= 1 x106 or 1MΩ making ‘b’ the answer.`,
    ...
    examStrategy: 2,
    examStrategyNotes:
      "What resistor is needed to only pass the required current?",
    examCalculation: 2,
    exam_NOT: false,
    tagged: false,
    obsidianURL: "",
  ...
  {
    source: "BBDL QUIZ WEEK13 Q02",
    question: `If you set the frequency of a crystal oscillator to 25.000MHz and your frequency meter is accurate to 10 parts per million, the actual frequency could be plus or minus:`,
    image: "",
...
250Hz. Looks like ‘a’ is the correct answer.`,
    ...
    examStrategy: 2,
    examStrategyNotes:
      "ppm means the number divided by a million. Multiply that by the frequency.",
    examCalculation: 2,
    exam_NOT: false,
    tagged: false,
    obsidianURL: "",
  ...
  {
    source: "BBDL QUIZ WEEK13 Q03",
    question: `You are using a signal generator with a source impedance of 50 Ohms to test two amplifiers for your latest homebrew transmitter. One of the amplifiers has an input impedance of 50 Ohms and the other 1000 Ohms but both amplifiers deliver the same output into a 50 Ohm dummy load.`,
    image: "",
    options: [
      "The results show that both amplifiers are suitable for your project",
      "The results show that input impedance has no effect on performance",
      "The results cannot be compared because the different source and input impedances may have had a significant effect on the results",
...
but we don’t know for sure. For that reason ‘c’ is correct and all others are incorrect.`,
  ...
  {
    source: "BBDL QUIZ WEEK13 Q04",
    question: `Which of the following would provide the BEST set up to measure the RF power from an SSB transmitter?`,
    image: "",
    options: [
      "A dummy load, an audio oscillator and an oscilloscope",
      "A dummy load, an SWR meter and an oscilloscope",
      "A dummy load, an audio oscillator and an SWR meter",
...
there is no mention of the ability to whistle. ‘a’ is therefore the ‘most correct’ answer here.`,
  ...
  },
  {
    ...
    options: [
      ...
      "A general coverage HF receiver calibrated against standard frequency transmissions",
      "An LF-VHF SDR with a 470kHz bandwidth",
...
frequency, irrespective of its usable range.<br><br>`,
  ...
  {
    source: "BBDL QUIZ WEEK13 Q06",
    question: `In the diagram, the meters M1 and M2 will be labelled:`,
    image: "images/week13-q06.png",
    options: [
      "X and Y",
      "Z In and Z Out",
      "Volts and Amps",
...
reflected.`,
  ...
  {
    source: "BBDL QUIZ WEEK13 Q07",
    question: `What is the frequency of the waveform shown on the oscilloscope display?`,
...
wave. Applying the f=1/t formula, 1 divided by one 1 x 10-3 = 1000 = 1kHz, making ‘b’ the correct answer.`,
  ...
  {
    source: "BBDL QUIZ WEEK13 Q08",
    question: `The display of a spectrum analyser is shown in the diagram. How many harmonics of the 10MHz signal are displayed?`,
...
are not multiples of 10MHz so are not harmonics of that signal.`,
  ...
  {
    source: "BBDL QUIZ WEEK13 Q09",
    question: `An RF amplifier with 50Ω input impedance delivers 1V peak to peak into a 50Ω load from an input of 1mV peak to peak. The amplifier’s power gain is:`,
    image: "",
...
in = 60dB = answer ‘b’ – double phew!`,
    ...
    examStrategy: 3,
    examStrategyNotes:
      "log 1000 is? For volts the multiplier is? Look on EX309.",
    examCalculation: 3,
    exam_NOT: false,
    tagged: true,
    obsidianURL: "",
  ...
  {
    source: "BBDL QUIZ WEEK13 Q10",
    question: `If a component is marked as 'NP0', that means:`,
    image: "",
    options: [
      "It has neither a negative nor a positive temperature coefficient",
      "It has neither an excess of negative electrons nor positive holes",
      "It has three terminals: negative (N), positive (P) and ground zero (0)",
...
only ‘zero coefficient’ ones, which means the same thing.`,
  ...
  {
    source: "BBDL QUIZ WEEK14 Q01",
    question: `You purchase a linear amplifier with no documentation. You test it with your transceiver running at 15W and you measure the output power as 600W. How much gain does the amplifier have?`,
    image: "",
    options: [`40dB`, `26dB`, `32dB`, `16dB`],
    correct: 3,
    explanation: ``,
    lookup: "See page(s) x of the Full Licence Manual",
    syllabus: "9b.1",
  ...
  {
    source: "BBDL QUIZ WEEK14 Q02",
    question: `An RF amplifier is able to deliver 200µW if receives a signal of 1µW from the antenna. What is the gain of the RF amplifier?`,
    image: "",
    options: [`23dB`, `46dB`, `90dB`, `200dB`],
    correct: 0,
    explanation: ``,
    lookup: "See page(s) x of the Full Licence Manual",
    syllabus: "9b.1",
  ...
  {
    source: "BBDL QUIZ WEEK14 Q03",
    question: `A 50 ohm attenuator is being tested. The RF voltmeter shows that when there is 15.8V RMS on the input, there is 7.9V RMS on the output. How much attenuation is being achieved?`,
    image: "",
    options: [`2dB`, `3dB`, `4dB`, `6dB`],
    correct: 3,
    explanation: ``,
    lookup: "See page(s) x of the Full Licence Manual",
    syllabus: "9b.1",
  ...
  {
    source: "BBDL QUIZ WEEK14 Q04",
    question: `You have just made your first homebrew receiver. You find that it can just about resolve a signal of 1µV from your signal generator. It performs well as you increase the output of the signal generator until you reach 10mV, when the signal starts to sound distorted. What is your receiver’s dynamic range?`,
    image: "",
    options: [`40dB`, `10dB`, `80dB`, `20dB`],
    correct: 2,
    explanation: ``,
    lookup: "See page(s) x of the Full Licence Manual",
    syllabus: "9b.1",
  ...
  {
    source: "BBDL QUIZ WEEK14 Q05",
    question: `You are measuring the output power from your new transmitter. You measure 142VRMS across a 50 ohm dummy load with the key down. What is the output power?`,
    image: "",
    options: [`16dBm`, `26dBm`, `32dBm`, `56dBm`],
    correct: 3,
    explanation: ``,
    lookup: "See page(s) x of the Full Licence Manual",
    syllabus: "9b.1",
  ...
  {
    source: "BBDL QUIZ WEEK14 Q06",
    question: `You run a linear amplifier at 1200 W output into an antenna with a gain of 9dB. The feeder has a loss of 3dB. Which of the following statements is correct?`,
    image: "",
    options: [
      `This may be illegal because the ERP is greater than 1 kW`,
      `This is illegal because a Full Licence holder is limited to 1 kW output power`,
      `This is legal because the power at the antenna feedpoint is only 600 W`,
      `This may be illegal because the ERP is greater than is permitted on some amateur bands`,
    ],
    correct: 3,
    explanation: ``,
    lookup: "See page(s) x of the Full Licence Manual",
  ...
  {
    source: "BBDL QUIZ WEEK14 Q07",
    question: `You have a bi-directional power meter in your antenna feeder, between your transmitter and the SWR meter. The forward power reads 199 W and the reflected power reads 2 W. What is the Return Loss and what would the SWR meter read?`,
    image: "",
    options: [
      `40dB return loss with high SWR`,
      `20dB return loss with high SWR`,
      `20dB return loss with low SWR`,
      `40dB return loss with low SWR`,
    ],
    correct: 2,
    explanation: ``,
    lookup: "See page(s) x of the Full Licence Manual",
  ...
  {
    source: "BBDL QUIZ WEEK14 Q08",
    question: `You have carried out an experiment with a friend with the following identical equipment set ups: <br><br>

<p>Transceiver 10 W output</p>
<p>Feeder 2dB loss</p>
<p>Antenna 9dB gain</p>
<br>
<p>The received signal is measured as -36dBm.</p> 
<br>
<p>What is the path loss?</p>`,
    image: "",
    options: [`-4dB`, `-36dB`, `-40dB`, `-90dB`],
    correct: 3,
    explanation: ``,
    lookup: "See page(s) x of the Full Licence Manual",
    syllabus: "9b.1",
  ...
  {
    source: "BBDL QUIZ WEEK14 Q09",
    question: `Your feeder loss is 3dB and your antenna has a gain of 6dBd. If your transmitter is set to maximum legal power on 10.1MHz. What is your effective radiated power?`,
    image: "",
    options: [`400W`, `800W`, `1600W`, `4000W`],
    correct: 2,
    explanation: ``,
    lookup: "See page(s) x of the Full Licence Manual",
    syllabus: "9b.1",
  ...
  {
    source: "BBDL QUIZ WEEK14 Q10",
    question: `You purchase a 100m spool of 50Ω coaxial feeder at a rally. 

You test it with your transceiver and you measure the output power at the end on 4 different bands. 

The results are shown below. On which band does the feeder have a loss of about 15dB?`,
    image: "images/week14-q10.png",
    options: [`1240MHz`, `432MHz`, `1.8MHz`, `5MHz`],
    correct: 1,
    explanation: ``,
    lookup: "See page(s) x of the Full Licence Manual",
    syllabus: "9b.1",
