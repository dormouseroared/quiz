const BBDL_FULL_QUIZZES = [
  ...
  },
  {
    ...
    correct: 1,
    explanation:
      "There are two key points to getting this one correct; the series resistors and the units. It is a ‘simple’ Ohm’s Law question, just complicated by there being two series resistors and the mixed units, so let’s deal with the series resistors first. Hopefully you remembered that series resistors simply add together to give the total resistance, RTotal. If you are happy ‘playing’ with numbers, you can rethink 330kΩ as 0.33MΩ, and add 1.2MΩ to get 1.53MΩ.",
  ...
  },
  {
    ...
    question:
      "If an inductor of 5uH is connected in series with a 22 ohm resistor, and a DC supply connected, how long will it take for the maximum current to be flowing?",
    image: "",
...
materials, whereas polythene is definitely a man-made sheet material.`,
  ...
  },
  {
    ...
    examStrategy: "4",
    examStrategyNotes:
      "Just have to work through the options. Make sure this is included in flashcards.",
    examCalculation: "0",
  },
  {
  ...
  },
  {
    ...
    correct: 0,
    explanation: `I answered B, so check similar answers by writing them down.`,
    lookup: "See page(s) x of the Full Licence text book",
    syllabus: "0",
    tagged: true,
    examStrategy: "4",
  ...
  },
  {
    ...
    syllabus: "0",
    examStrategy: "4",
    examStrategyNotes: "Chose an answer based on evaluation of each option.",
    examCalculation: "0",
  },
  {
    ...
    syllabus: "0",
    examStrategy: "4",
    examStrategyNotes: "Just have to evaluate answers.",
    examCalculation: "0",
    exam_NOT: true,
  },
  {
