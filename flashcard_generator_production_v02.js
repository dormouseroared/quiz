...
Filename: flashcard_generator_production_v02.js

- Generates two PDFs: flashcards_front.pdf and flashcards_back.pdf

- A4 portrait, 2 cards per page (top & bottom)
- LARGE FONTS: Configurable sizes (default 22px content, 18px headers)
...
Usage:
  - Basic: node flashcard_generator_production_v02.js
  - With filters: node flashcard_generator_production_v02.js --keys=2d.1,3a.2
  - Debug mode: node flashcard_generator_production_v02.js --debug
...
if (cliOptions.help) {
  console.log(`
🃏 Flashcard Generator Production

Usage:
  node flashcard_generator_production_v02.js [options]
...
Examples:
  node flashcard_generator_production_v02.js
  node flashcard_generator_production_v02.js --keys=2d.1,2d.2 --debug
  node flashcard_generator_production_v02.js --levels=full
`)
  process.exit(0)
}

// ---------- Enhanced config with new options ----------
// content 24pt -> 22pt, lists lineHeight 1.4 -> 1.2, math 26pt -> 24pt
// could probably all be done with config somehow outside this code
const defaultConfig = {
  page: {
    width_mm: 210,
    height_mm: 297
...
async function main() {
  try {
    ...
    console.log('\n🚀 Flashcard Generator Production Complete!')
