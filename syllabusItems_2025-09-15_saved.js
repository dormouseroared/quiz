const syllabusItems = [
    {
        ...
        flashcards: [
            ...
            {
                front: "<span style='color: purple;'>Flashcard Generator Production changes v01 -> v02:</span><ul><li>content 24pt -> 22pt</li><li>math 26pt -> 22pt</li><li>lists lineHeight 1.4 -> 1.2</li><li>printing includeIncomplete false -> true</li></ul>",
                back: "",
                status: "to do"
            },
        ]
